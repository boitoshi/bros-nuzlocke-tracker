...
# docker build -t bros_nuzlocke_tracker .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name bros_nuzlocke_tracker bros_nuzlocke_tracker
